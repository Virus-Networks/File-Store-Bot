...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 ᴊᴏɪɴ ᴀʟʟ ᴄʜᴀɴɴᴇʟs', url='https://t.me/addlist/8vupr4H_5zM5ZjQ1')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/VIRUS_BOTZ_SUPPORT_GROUP'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/virus_botz')
            ],[
